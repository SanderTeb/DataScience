...
FREEZE_LAYERS = True #False  # Set to True if you want to freeze the layers
if FREEZE_LAYERS:
...
history = train_model(
    ...
    filename_base="resnet18_transfer_learning_freeze_layers" if FREEZE_LAYERS else "resnet18_transfer_learning",
    verbose=True
)
